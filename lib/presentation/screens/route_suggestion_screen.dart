          ...
          child: Column(
            children: [
              const Padding(
                ...
                child: Text("Select Tour Duration", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: AppColors.primary)),
              ),
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    int hours = index + 1;
                    return ListTile(
                      title: Text("$hours Hours", textAlign: TextAlign.center, style: const TextStyle(fontSize: 16)),
                      onTap: () {
                        setState(() {
...
Future<void> _generateAiTour() async {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Icon(icon, size: 18, color: isSelected ? Colors.white : AppColors.iconGrey),
  ...
  Widget _buildInputForm() {
    return Column(
      ...
      children: [
        const Text("Design your perfect evening", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: AppColors.primary)),
        const SizedBox(height: 20),
        
        const Text("What are you in the mood for?", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
        const SizedBox(height: 10),
        Wrap(
          spacing: 10,
          runSpacing: 10,
          children: _categories.map((cat) => _buildCategoryChip(cat['name'], cat['icon'])).toList(),
        ),
  ...
  /// Dynamically builds the step-by-step timeline using your custom EventCard
  Widget _buildAiTimeline() {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 5),
        Text("Estimated time: ${_generatedTour!['total_estimated_hours']} hours", style: const TextStyle(color: Colors.grey)),
        const SizedBox(height: 30),
        
        // Render the list of AI-generated stops using your custom UI
        ...stops.map((stop) {
          return Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                // --- YOUR CUSTOM EVENT CARD ---
                Expanded(
                  child: EventCard(
                    title: stop['title'],
                    imagePath: stop['image'] ?? stop['Image'] ?? "https://www.visitsaudi.com/content/dam/saudi-tourism/media/diriyah/at-turaif.jpg",
                    description: stop['reasoning'], 
                    schedule: "${stop['duration_minutes']} Minutes",
                    price: "Part of Tour",
                    crowdStatus: "Moderate", 
                    onSuggestRoute: () {
                      // Logic to open Map route
                    },
                  ),
                ),
              ],
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("AI Route Generator", style: TextStyle(color: AppColors.primary, fontWeight: FontWeight.bold)),
        centerTitle: true,
      ),
      body: Column(
        children: [
                ...
                ? const Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 20),
                        Text("Wasel AI is calculating traffic and crafting your perfect tour...", textAlign: TextAlign.center, style: TextStyle(color: Colors.grey))
                      ],
                    )
                  )
                : _errorMessage != null 
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('Generate Smart Route', style: TextStyle(fontSize: 18, color: Colors.white, fontWeight: FontWeight.bold)),
                ),
              ),
            ),
             ...
             Padding(
              ...
              child: SizedBox(
                ...
                child: OutlinedButton(
                  ...
                  child: const Text('Start Over', style: TextStyle(fontSize: 18, color: AppColors.primary, fontWeight: FontWeight.bold)),
                ),
              ),
            ),
        ],
